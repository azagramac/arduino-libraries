...
#include <stdbool.h>
#include <lib/t1oi2c/phNxpEseProto7816_3.h>
#include <lib/t1oi2c/phNxpEsePal_i2c.h>
#include <lib/t1oi2c/phEseTypes.h>
#include "lib/platform/arduino/sm_timer.h"
#include "lib/apdu/se05x_tlv.h"
...
static uint16_t phNxpEseProto7816_ComputeCRC(unsigned char *p_buff, uint32_t offset, uint32_t length)
{
    uint16_t CAL_CRC = 0xFFFF, CRC1 = 0x0000;
    uint32_t i = 0;
    ...
    CRC1 = ((CAL_CRC & 0xFF) << 8) | ((CAL_CRC >> 8) & 0xFF);
#elif defined(T1oI2C_GP1_0)
    CRC1 = CAL_CRC;
#endif
exit:
    return (uint16_t)CRC1;
}
